...
const updateMember = async (req, res) => {
  try {
    ...
    await memberService.updateMember(id, req.body);
...
//  * GET /api/members?page=1&limit=10&search=Abebe
//  * GET /api/members?page=1&limit=10&status=Active
//  * GET /api/members?page=1&limit=10&roleId=1
//  * GET /api/members?page=1&limit=10&search=Abebe&status=Active
//  * GET /api/members?page=1&limit=10&search=Abebe&status=Active&roleId=1
//  */
...
//     if (
//       roleId !== "" &&
//       (!Number.isInteger(roleId) || roleId < 1 || roleId > 4)
//     ) {
//       return errorResponse(
//         res,
...
//     return errorResponse(
//       res,
//       error.message || "Failed to retrieve members",
//       error.statusCode || 500
//     );
//   }
// };
